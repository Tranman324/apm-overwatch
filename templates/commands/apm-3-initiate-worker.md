...
<!-- OVERWATCH BEGIN -->
   Preserve any Verification State from the Handoff Log, handoff prompt, and loaded current Stage Task Logs: claims checked, proof verdicts, proof commands or artifacts, and residuals still open.
<!-- OVERWATCH END -->
...
<!-- OVERWATCH BEGIN -->
   Include whether Verification State was loaded and which residuals, if any, are being carried forward.
<!-- OVERWATCH END -->
5. Check Task Bus:
